...
/* make collapse of navbar at * instead of standard 768px
copied from https://coderwall.com/p/wpjw4w/change-the-bootstrap-navbar-breakpoint*/
@media (max-width: 900px) {
  ...
  .navbar-nav .open .dropdown-menu {
      ...
      .navbar-custom .nav li.dropdown-toggle a:hover{
        color: #000;
      }
    ...
    .navbar-collapse.collapse {     /*When it is collapsed show nothing*/
    ...
    .navbar-nav {
        float: none!important;
        margin-top: 7.5px;
        /*font-size:30px!important;*/ /*tentar isto: como temos a navbar supostamente antes do colapso não dá para fazer override a essa formatação, namely o alinhamento central. Então podemos fazer tudo central à partida e se o tamanho for maior que x alinhamos à esquerda, direita, wtv
        */
        text-align:center;
    }
    .navbar-nav>li {
