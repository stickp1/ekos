...
<!-- Header -->
            ...
            <div class="panel with-nav-tabs panel-default" style='background:transparent'>
                <div class="panel-heading">
                        <ul class="nav nav-tabs" id='submenu'>
                            <li <?=  @$this->request->params['param'] == 'inscricoes' ||  @$this->request->params['param'] == null ? 'class="active"': ''?>><a href="#inscricoes" data-toggle="tab">Inscrições</a></li>
                            <li <?=  @$this->request->params['param'] == 'exame' ? 'class="active"': ''?>><a href="#exame" data-toggle="tab">Exame</a></li>
                            <li <?=  @$this->request->params['param'] == 'matriz' ? 'class="active"': ''?>><a href="#matriz" data-toggle="tab">Bibliografia</a></li>
                            <li <?=  @$this->request->params['param'] == 'faq' ? 'class="active"': ''?>><a href="#faq" data-toggle="tab">FAQs</a></li>
                        </ul>
                </div>
  ...
  <div class="card">
    <div class="card-header" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" >
        ...
        <i class="fa fa-chevron-down" id='arrow_collapseOne' style='float:right; margin-right: 20px; margin-top:5px'></i>
    </div>
...
<!-- Fecha acordião -->
        ...
        <p style='font-size:12px; text-align: right'> * MD - Mecanismo de Doença; D - Diagnóstico; P - Prevenção; T - Terapêutica; GD - Gestão do Doente</p>

<p style='text-align:center'>
            <button class="btn btn-black" onclick="window.open('http://ekos.pt/matriz-ekos.pdf')" style='margin-top:50px'>GUARDAR PDF</button></p>
                    </div>
