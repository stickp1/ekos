...
<section>
  <div class="container text-center">
    <div class="row">
      ...
      <p>FMUL</p>
      <p class='small' style='margin-bottom: 50px'>Faculdade de Medicina de Lisboa <br> Avenida Professor Egas Moniz, <br> 1649-028 Lisboa</p>
<!--
      <p>NMS|FCM</p>
      	...
      	<div class='row'>
      		<div class='col-md-12'>
      			<div class="form-group">
                    ...
                    <div class="g-recaptcha" data-sitekey="6LdAL20UAAAAAJOZy5YPgXQR_u26zrk1Y8hEfuM2" style='float: right; margin-top:15px; display: none'></div>
